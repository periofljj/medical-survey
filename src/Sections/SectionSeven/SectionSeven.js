                            ...
                            <div className="left-container">
                                <div className="sub-box-row-1">
                                    ...
                                    <div className="sub-box sub-box-2">
                                        ...
                                        <div className="box-content">
                                            <input className="date-input" type="text" /><input className="date-input" type="text" /><input className="date-input" type="text" />
                                        </div>
                                    </div>
                            ...
                            <div className="right-container">
                                ...
                                <div className="sub-box-2-col">
                                    <div className="sub-box sub-box-col-1">
                                        ...
                                        <div className="box-content">
                                            <div>
                                                <span>每几</span><input type="number" /><span>天</span>
                                            </div>
                                            <div>
                                                <span>每几</span><input type="number" /><span>周</span>
                                                <input className="times" type="number" /><span>次数</span>
                                            </div>
                                            <div>
                                                <span>每几</span><input type="number" /><span>个月</span>
                                            </div>
                                        </div>
                                    </div>
