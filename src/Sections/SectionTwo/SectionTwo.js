                        ...
                        <div className="box box-1">
                            ...
                            <div className="box-1-1">
                                ...
                                <div className="box-content">
                                    <div className="box-col">
                                        <div><input type="radio" name="" />0</div>
                                        <div><input type="radio" name="" />Ⅰ</div>
                                        <div><input type="radio" name="" />Ⅰb</div>
                                        <div><input type="radio" name="" />Ⅱ</div>
                                        <div><input type="radio" name="" />Ⅱb</div>
                                        <div><input type="radio" name="" />Ⅲ</div>
                                        <div><input type="radio" name="" />Ⅲb</div>
                                        <div><input type="radio" name="" />Ⅳ</div>
                                        <div><input type="radio" name="" />Ⅳb</div>
                                    </div>
                                    <div className="box-col">
                                        <div><input type="radio" name="" />Ⅰa</div>
                                        <div><input type="radio" name="" />Ⅰc</div>
                                        <div><input type="radio" name="" />Ⅱa</div>
                                        <div><input type="radio" name="" />Ⅱc</div>
                                        <div><input type="radio" name="" />Ⅲa</div>
                                        <div><input type="radio" name="" />Ⅲc</div>
                                        <div><input type="radio" name="" />Ⅳa</div>
                                        <div><input type="radio" name="" />Ⅳc</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="box-1-2">
                                <div className="box box-1-2-1">
                                    ...
                                    <div className="box-content">
                                        <div className="box-col">
                                            <div>T <input type="radio" name="" /></div>
                                            <div>N <input type="radio" name="" /></div>
                                            <div>M <input type="radio" name="" /></div>
                                        </div>
                                    </div>
                                </div>
                                <div className="box box-1-2-2">
                                    <div className="box-col">
                                        <div><input type="radio" name="" />局限期</div>
                                        <div><input type="radio" name="" />局部晚期</div>
                                    </div>
                                    <div className="box-col">
                                        <div><input type="radio" name="" />晚期</div>
                                        <div><input type="radio" name="" />局部晚期</div>
                                    </div>
                                </div>
                            </div>
                            <div className="box box-1-3">
                                ...
                                <div className="box-content">
                                    ...
                                    <div><input type="radio" name="" /> B</div>
                                    <div><input type="radio" name="" /> C</div>
                                    <div><input type="radio" name="" /> D</div>
                                </div>
                            </div>
                            <div className="space"></div>
                                ...
                                <div className="box-content">
                                        ...
                                        <div className="box-col">
                                            <div className="col-left">
                                                <div className="col-content">
                                                    <div><input type="radio" name="ann-arbor" /> Ⅰ</div>
                                                    <div><input type="radio" name="ann-arbor" /> Ⅰa</div>
                                                    <div><input type="radio" name="ann-arbor" /> Ⅰb</div>
                                                </div>
                                                <div className="col-content">
                                                    <div><input type="radio" name="ann-arbor" /> Ⅰ</div>
                                                    <div><input type="radio" name="ann-arbor" /> Ⅰa</div>
                                                ...
                                                <div className="col-content">
                                                    <div><input type="radio" name="ann-arbor" /> Ⅲ</div>
                                                    <div><input type="radio" name="ann-arbor" /> Ⅲa</div>
                                                    <div><input type="radio" name="ann-arbor" /> Ⅲb</div>
                                                </div>
                                                <div className="col-content">
                                                    <div><input type="radio" name="ann-arbor" /> Ⅳ</div>
                                                    <div><input type="radio" name="ann-arbor" /> Ⅳa</div>
                                                    <div><input type="radio" name="ann-arbor" /> Ⅳb</div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="box-content3">
                                        <div className="box-left">
                                            <div><input type="radio" name="" /> 低度恶性/惰性</div>
                                            <div><input type="radio" name="" /> 中度恶性/侵袭性</div>
                                            <div><input type="radio" name="" />  度恶性/ 侵袭性</div>
                                        </div>
                                 ...
                                 <div className="box box-3-1">
                                    ...
                                    <div className="box-content2">
                                        <div className="box-col">
                                            <div className="col-left">
                                                <div className="col-content">
                                                    <div><input type="radio" name="" /> M0</div>
                                                    <div><input type="radio" name="" /> M2</div>
                                                </div>
                                                <div className="col-content">
                                                    <div><input type="radio" name="" /> M1</div>
                                                    <div><input type="radio" name="" /> M3</div>
                                                </div>
                                                <div className="col-content">
                                                    <div><input type="radio" name="" /> M4</div>
                                                    <div><input type="radio" name="" /> M5</div>
                                                </div>
                                                <div className="col-content">
                                                    <div><input type="radio" name="" />M6</div>
                                                    <div><input type="radio" name="" /> M7</div>
                                                </div>
                                            </div>
                                            <div className="col-right">
                                                <div className="col-content">
                                     ...
                                     <div className="box-content">
                                        ...
                                        <div className="box-content2">
                                            <div className="box-col">
                                                <div className="col-left">
                                                    <div className="col-content">
                                                        <div><input type="radio" name="" /> A期</div>
                                                    </div>
                                                    <div className="col-content">
                                                        <div><input type="radio" name="" /> B期</div>
                                                    </div>
                                                    <div className="col-content">
                                                        <div><input type="radio" name="" /> C期</div>
                                                    </div>
                                                </div>
                                                <div className="col-right">
                                                    <div className="col-content">
                                    ...
                                    <div className="box-content">
                                        ...
                                        <div className="box-content2">
                                            <div className="box-col">
                                                <div className="col-left">
                                                    <div className="col-content">
                                                        <div><input type="radio" name="" /> 慢性期</div>
                                                    </div>
                                                    <div className="col-content">
                                                        <div><input type="radio" name="" /> 加速期</div>
                                                    </div>
                                                    <div className="col-content">
                                                        <div><input type="radio" name="" /> 急性变期</div>
                                                    </div>
                                                </div>
                                                <div className="col-right">
                                                    <div className="col-content">
                            ...
                            <div className="box-content">
                                ...
                                <div className="box-content2">
                                    <div className="box-col">
                                        <div className="col-left">
                                            <div className="col-content">
                                                <div><input type="radio" name="" /> 极低危</div>
                                            </div>
                                            <div className="col-content">
                                                <div><input type="radio" name="" /> 低危</div>
                                            </div>
                                            <div className="col-content">
                                                <div><input type="radio" name="" /> 中危</div>
                                            </div>
                                            <div className="col-content">
                                                <div><input type="radio" name="" /> 高危</div>
                                            </div>
                                            <div className="col-content">
                                                <div><input type="radio" name="" /> 极高危</div>
                                            </div>
                                        </div>
                                        <div className="col-right">
                                            <div className="col-content">
                ...
                <div className="section-content">
                    ...
                    <div className="box box-5">
                        <div className="box box-5-1">
                            ...
                            <div className="box-content">
                                <div className="box-col">
                                    <div><input type="radio" name="" /> 1.AML伴重现性染色体异常</div>
                                ...
                                <div className="box-col">
                                    <div><input type="radio" name="" /> 5. 髓样肉瘤</div>
                                ...
                                <div className="box-col">
                                    <div><input type="radio" name="" /> 7.原始浆细胞样树突细胞肿瘤.</div>
                                    <div>7.Blastic plasmacytoid dendritic cell neoplasm</div>
                                </div>
                                <div className="box-col">
                                    <div><input type="radio" name="" /> 系列未明急性白血病</div>
                                    <div></div>
                                </div>
                                <div className="col-list">
                                    <ul>
